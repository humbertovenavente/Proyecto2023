...
const Medicina = ({ articles }) => {
  // Verificar si hay al menos un artículo en el arreglo
  return (
    <div>
      <h3>Bienvenidos al Medicina, en esta parte se mostrarán los artículos que hayan sido publicados recientemente</h3>
